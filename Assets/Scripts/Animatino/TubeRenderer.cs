...
public class TubeRenderer : MonoBehaviour
{
    ...
    public void Reset()
    {
        ...
        vertices[0] = new TubeVertex(Vector3.zero, radius, Color.white);
        vertices[1] = new TubeVertex(Vector3.right, radius, Color.white);
    }
    ...
    void Start()
    {
        ...
        myMeshRenderer.shadowCastingMode = (castShadows) ? UnityEngine.Rendering.ShadowCastingMode.On : UnityEngine.Rendering.ShadowCastingMode.Off;
        myMeshRenderer.receiveShadows = receiveShadows;
